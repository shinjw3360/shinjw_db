...
-- 데이터 추가
INSERT INTO tasks (_id, title, description, date, isCompleted, isImportant, userId) VALUES ('1234', '할일1', '할일1 설명', '2021-08-01', false, false, 'shinjw');

-- 데이터 조회
SELECT * FROM tasks WHERE userId = 'shinjw' ORDER BY created_at DESC(ASC);

-- 특정 사용자 데이터 필터 조회
SELECT * FROM tasks WHERE userId = 'shinjwh'
